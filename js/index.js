...
function redisplayLocalStorage() {
  ...
  $('.section__bottom').prepend(
    `<article class="card">
      <article id="${object.id}" class="container">
        ...
        <input class="article__button-delete" type="" alt="delete button" aria-label="delete button" src="">
        <p class="article__p-content" contenteditable="true">${object.inputBody}</p>
      </article>
      <article class="container2">
        <input class="article__button-upvote" type="" alt="upvote button" aria-label="upvote button" src="">
        <input class="article__button-downvote" type="" alt="downvote button" aria-label="downvote button" src="">
...
function increaseQuality() {
  ...
  cardList.forEach(function (card) {
    if (idea.id === card.id && card.qualityValue <= 2) {
      card.qualityValue++;
